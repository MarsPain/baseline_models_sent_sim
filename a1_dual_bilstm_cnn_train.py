...
tf.app.flags.DEFINE_string("ckpt_dir","dual_bilstm_1","checkpoint location for the model") #dual_bilstm_char_checkpoint/
...
tf.app.flags.DEFINE_string("name_scope","dual_bilstm_1","name scope value.") #bilstm_char
...
tf.app.flags.DEFINE_integer("decay_steps", 10000000, "how many steps before decay learning rate.")
tf.app.flags.DEFINE_float("decay_rate", 0.0000001, "Rate of decay for learning rate.")
