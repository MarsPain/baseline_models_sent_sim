...
tf.app.flags.DEFINE_integer("num_filters",128, "number of filters") #64
...
tf.app.flags.DEFINE_string("traning_data_path","data/atec_nlp_sim_train_data.csv","path of traning data.")
...
def main(_):
    ...
    print("valid_nums:", len(validX1))
    testX1,testX2, testBlueScores,testY = test
    print("test_nums:", len(testX1))
