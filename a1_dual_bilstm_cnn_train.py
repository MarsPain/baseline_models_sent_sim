...
tf.app.flags.DEFINE_string("ckpt_dir","dual_cnn_1","checkpoint location for the model") #dual_bilstm_char_checkpoint/
...
tf.app.flags.DEFINE_string("name_scope","dual_cnn_1","name scope value.") #bilstm_char
